...
var ClapprPeer5Playback = (function (_Playback) {
    function ClapprPeer5Playback() {
        _classCallCheck(this, ClapprPeer5Playback);

        if (_Playback != null) {
            _Playback.apply(this, arguments);
        }
    }

    _inherits(ClapprPeer5Playback, _Playback);

    _createClass(ClapprPeer5Playback, [{
        key: 'name',
        get: function () {
            return 'clappr_peer5_playback';
        }
    }, {
        key: 'render',
